...
const formSchema = z.object({
  ...
  message: z.string().min(1, "O nome é obrigatório"),
...
export function FormDonate({ slug, creatorId }: FormDonateProps) {
  ...
  async function onSubmit(data: FormData) {
    ...
    await hanglePaymentResponse(checkout)
  }

  async function hanglePaymentResponse(checkout: { sessionId?: string, error?: string }) {
